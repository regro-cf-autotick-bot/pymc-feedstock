...
pixi add pymc pymc-base
# for installing globally
pixi global install pymc pymc-base
```
...
It is possible to list all of the versions of `pymc` available on your platform:
...
```
pixi search pymc --channel conda-forge
```
